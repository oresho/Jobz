...
function JobPage() {
    ...
    const deleteJob = async (jobId) => {
        ...
        if(!confirm) return;
        try {
            const response = await client.delete(`/${jobId}`); // Send newJob directly as request body
            navigate("/jobs");
        } catch (error) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
          ...
          <aside>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="my-2 bg-indigo-100 p-2 font-bold overflow-hidden">
...
const jobLoader = async ({params}) => {
    ...
    try {
        ...
        jobResponse = response.data.data;
        console.log(jobResponse);
    } catch (error) {
        console.log('Error Fetching Data', error);
    } 
